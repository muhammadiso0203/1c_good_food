...
const data = [
  { name: 'До 25 лет', value: 180, color: '#3b82f6' },
  { name: '25-35 лет', value: 480, color: '#10b981' },
  { name: '35-50 лет', value: 420, color: '#f59e0b' },
  { name: 'Старше 50 лет', value: 160, color: '#ef4444' },
];

const StaffAgeCompositionChart = () => {
  return (
            ...
            <Legend
              ...
              formatter={(value, entry: any) => (
                <span className="text-[13px] font-medium dark:text-gray-300" style={{ color: entry.color }}>
                  {value}: {data.find((d) => d.name === value)?.value} чел.
                </span>
              )}
            />
          </PieChart>
...
export default StaffAgeCompositionChart;
