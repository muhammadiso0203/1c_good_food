...
const data = [
  { name: 'ФОТ (Зарплата)', value: 1.8, color: '#3b82f6' },
  { name: 'Налоги', value: 0.36, color: '#ef4444' },
  { name: 'Поставщики ТМЦ', value: 0.9, color: '#f59e0b' },
  { name: 'Услуги и обслуживание', value: 0.3, color: '#10b981' },
  { name: 'Прочее', value: 0.24, color: '#a855f7' },
];

const OutflowStructureChart = () => {
  return (
    <div className="w-full h-[400px] bg-white dark:bg-slate-800 p-6 rounded-[12px] border border-gray-200 dark:border-slate-700 mt-6">
      <h3 className="text-[18px] font-semibold text-gray-900 dark:text-white mb-6">
        Структура выплат по статьям (млрд сум)
      </h3>
...
export default OutflowStructureChart;
