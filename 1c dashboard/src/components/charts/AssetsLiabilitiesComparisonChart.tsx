...
const data = [
  { name: '2021', assets: 1.5, liabilities: 0.8 },
  { name: '2022', assets: 1.8, liabilities: 0.9 },
  { name: '2023', assets: 2.0, liabilities: 1.0 },
  { name: '2024', assets: 2.2, liabilities: 1.1 },
  { name: '2025', assets: 2.3, liabilities: 1.1 },
  { name: '2026 (П)', assets: 2.4, liabilities: 1.1 },
];
...
const AssetsLiabilitiesComparisonChart = () => {
  return (
    <div className="w-full h-[400px] bg-white dark:bg-slate-800 p-6 rounded-[12px] border border-gray-200 dark:border-slate-700 mt-6">
      <h3 className="text-[18px] font-semibold text-gray-900 dark:text-white mb-6">
        Сравнение активов и обязательств (трлн сум)
      </h3>
...
export default AssetsLiabilitiesComparisonChart;
